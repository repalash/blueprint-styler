...
import { ContextMenu, Classes as PopoverClasses, Tooltip } from "@blueprintjs/core";
...
const contentSizing = { popoverProps: { popoverClassName: PopoverClasses.POPOVER_CONTENT_SIZING } };
